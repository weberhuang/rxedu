...
<body>
	...
	<div id="clazz_tb" style="padding: 5px; height: auto">
		<div style="margin-bottom: 5px">
			<a href="javascript:$.ad.toAdd('clazz_w',I18N.clazz,'clazz_add','${ctx }/clazz/add');" class="easyui-linkbutton easyui-tooltip" 
				iconCls="icon-add" plain="true"><s:message code='comm.add' /></a> 
			<a href="javascript:$.ad.toUpdate('clazz_grid','clazz_w',I18N.user,'clazz_add','${ctx }/clazz/update')"
				class="easyui-linkbutton easyui-tooltip"  iconCls="icon-edit" plain="true"><s:message code='comm.update' /></a>
			<a href="javascript:$.ad.doDelete('clazz_grid','${ctx }/clazz/delete')" class="easyui-linkbutton easyui-tooltip"  iconCls="icon-remove"
